...
$sql="SELECT * FROM district WHERE row_no='$row_no'";
...
?>
<form method='POST' action='update_district.php'>
<table>


<h3><tr><td>Change Name:</td><td><input type='text' name='new_name'></td></tr></h3>
<h3><tr><td>Change Zone:</td><td><select name='new_zone'><?php
